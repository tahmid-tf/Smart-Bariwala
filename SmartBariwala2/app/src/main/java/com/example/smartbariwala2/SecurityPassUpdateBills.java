...
public class SecurityPassUpdateBills extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_security_pass_update_bills);

        getSupportActionBar().setTitle("Home");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);


        ownersNumberSecurityAdd = (EditText) findViewById(R.id.ownersNumberSecurityUpdate);
        rentersSetupPasswordAdd = (EditText) findViewById(R.id.rentersSetupPasswordUpdate);
        proceedToNextPageAdd = (Button) findViewById(R.id.proceedToNextPageUpdate);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.proceedToNextPageUpdate){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child(ownersNumberSecurity1).exists()){
                    ...
                    if (rentersPassword1.equals(rentersSetupPassword1) && ownersNumberSecurity1.equals(ownersPhoneNumber1)){
                        ...
                        Intent intent = new Intent(getApplicationContext(),OwnerUpdateBills.class);
