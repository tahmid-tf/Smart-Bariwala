...
public class ShowComplainSecurityPass extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_complain_security_pass);

        getSupportActionBar().setTitle("Home");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        ownersNumberSecurityAdd = (EditText) findViewById(R.id.ownersNumberSecurityComplain);
        rentersSetupPasswordAdd = (EditText) findViewById(R.id.rentersSetupPasswordComplain);
        proceedToNextPageAdd = (Button) findViewById(R.id.proceedToNextPageComplain);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.proceedToNextPageComplain){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child(ownersNumberSecurity1).exists()){
                    ...
                    if (rentersPassword1.equals(rentersSetupPassword1) && ownersNumberSecurity1.equals(ownersPhoneNumber1)){
                        ...
                        Intent intent = new Intent(getApplicationContext(),ShowRentersComplain.class);
