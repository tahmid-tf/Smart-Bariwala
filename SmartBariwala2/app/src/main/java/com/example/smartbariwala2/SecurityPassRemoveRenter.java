...
public class SecurityPassRemoveRenter extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_security_pass_remove_renter);

        getSupportActionBar().setTitle("Home");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        ownersNumberSecurityAdd = (EditText) findViewById(R.id.ownersNumberSecurityRenterS);
        rentersSetupPasswordAdd = (EditText) findViewById(R.id.rentersSetupPasswordRenterS);
        rentersUnitDelete = (EditText) findViewById(R.id.rentersUnitDelete);
        proceedToNextPageAdd = (Button) findViewById(R.id.proceedToNextPageRenterS);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.proceedToNextPageRenterS){
                    ...
                    if (rentersPassword1.equals(rentersSetupPassword1) && ownersNumberSecurity1.equals(ownersPhoneNumber1)){
                        ...
                        databaseReference.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.child(ownersNumberSecurity1).child("renters-info").child(rentersUnitDelete1).exists()){

                                    databaseReference.child(ownersNumberSecurity1).child("renters-info").child(rentersUnitDelete1).removeValue();
                                    ...
                                    Toast.makeText(getApplicationContext(),"Unit info does not exists",Toast.LENGTH_SHORT).show();
