...
public class SecurityPassOwnerRenterSetupPass extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_security_pass_owner_renter_setup_pass);

        ownersNumberSecurityAdd = (EditText) findViewById(R.id.ownersNumberSecuritySetPass);
        rentersSetupPasswordAdd = (EditText) findViewById(R.id.rentersSetupPasswordSetPass);
        proceedToNextPageAdd = (Button) findViewById(R.id.proceedToNextPageSetPass);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.proceedToNextPageSetPass){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child(ownersNumberSecurity1).exists()){
                    ...
                    if (rentersPassword1.equals(rentersSetupPassword1) && ownersNumberSecurity1.equals(ownersPhoneNumber1)){
                        ...
                        Intent intent = new Intent(getApplicationContext(),OwnersSetupRentersPass.class);
