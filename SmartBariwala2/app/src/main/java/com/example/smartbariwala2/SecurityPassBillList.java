...
public class SecurityPassBillList extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_security_pass_bill_list);

        getSupportActionBar().setTitle("Home");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);


        ownersNumberSecurityAdd = (EditText) findViewById(R.id.ownersNumberSecurityBillList);
        rentersSetupPasswordAdd = (EditText) findViewById(R.id.rentersSetupPasswordBillList);
        proceedToNextPageAdd = (Button) findViewById(R.id.proceedToNextPageBillList);
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.proceedToNextPageBillList){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child(ownersNumberSecurity1).exists()) {
                    ...
                    if (rentersPassword1.equals(rentersSetupPassword1) && ownersNumberSecurity1.equals(ownersPhoneNumber1)) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), OwnersBillList.class);
