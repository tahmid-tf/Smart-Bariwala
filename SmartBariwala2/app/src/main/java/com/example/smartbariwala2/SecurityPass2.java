...
public class SecurityPass2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_security_pass2);

        getSupportActionBar().setTitle("Home");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);


        ownersNumberSecurityAdd = (EditText) findViewById(R.id.ownersNumberSecurityAdd);
        rentersSetupPasswordAdd = (EditText) findViewById(R.id.rentersSetupPasswordAdd);
        proceedToNextPageAdd = (Button) findViewById(R.id.proceedToNextPageAdd);
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.proceedToNextPageAdd){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child(ownersNumberSecurity1).exists()){
                    ...
                    if (rentersPassword1.equals(rentersSetupPassword1) && ownersNumberSecurity1.equals(ownersPhoneNumber1)){
                        ...
                        Intent intent = new Intent(getApplicationContext(),OwnersAddBills.class);
