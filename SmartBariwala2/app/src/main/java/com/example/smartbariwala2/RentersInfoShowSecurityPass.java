...
public class RentersInfoShowSecurityPass extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_renters_info_show_security_pass);

        getSupportActionBar().setTitle("Home");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);


        ownersNumberSecurityAdd = (EditText) findViewById(R.id.ownersNumberSecurityShowRenter);
        rentersSetupPasswordAdd = (EditText) findViewById(R.id.rentersSetupPasswordShowRenter);
        proceedToNextPageAdd = (Button) findViewById(R.id.proceedToNextPageShowRenter);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.proceedToNextPageShowRenter){
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child(ownersNumberSecurity1).exists()){
                    ...
                    if (rentersPassword1.equals(rentersSetupPassword1) && ownersNumberSecurity1.equals(ownersPhoneNumber1)){
                        ...
                        Intent intent = new Intent(getApplicationContext(),ShowRentersInfoPage.class);
